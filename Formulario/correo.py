...
# Oculta la contraseña visualmente
...
def Cuenta_de_acceso():
    ...
    try:
        ...
        print(f"{marco+fondo}█                                                                                       █{fin}")
        print(f"{marco+fondo}█           {texto}Un momento por favor estamos ingresando a su cuenta de correo...            {fin+marco}█{fin}")
...
def Envio_del_mensaje(Correo_electronico, Datos: dict):
    ...
    try:
        ...
        print(f"{marco+fondo}█ {texto}Se enviara el mensaje a la casilla de correo -> {texto_correcto}{Destinatario:^35}   {fin+marco}█{fin}")
