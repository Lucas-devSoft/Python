...
def Menu_formulario(Estado: str, Version: str, Nombre_servidor: str, Nombre_base_de_datos: str,
                    Nombre_documentacion: str, estado_A: str, estado_B: str, estado_C: str):
    
    print(f"""
{marco+fondo}█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█{fin}
{marco+fondo}█  {texto}Estado de la Conexión : {Estado}          {texto}MongoDB Version : {Version}                  {fin+marco}█{fin}
{marco+fondo}█                                                                                       █{fin}
...
def Menu_formulario_completado(Estado: str, Version: str, Nombre_servidor: str, Base_de_Datos: str,
