...
while True:
    ...
    if option == 'A' and not status_A == ' COMPLETE ':
        ...
        if status_A in ' COMPLETE ' and status_B in ' COMPLETE ' and status_C in ' COMPLETE ':          
            
            cont +=1
            
            Personal_data = {   "_id"           : cont,
                                "PERSONAL DATA" : {"HEAD IN YOUR FAMILY"        : Boss,
                                                    "NAME"                      : Name,
                                                    "LASTNAME"                  : LastName,
                                ...
                                "WORK DATA"     : { "YOU ARE CURRENTLY WORKING" : work,
                                ...
                                "ACADEMIC DATA" : {"ARE YOU A GRADUATE"         : graduate,
        ...
        elif option == 'A' and status_A in ' COMPLETE ' or  option == 'B' and status_B in ' COMPLETE ' or option == 'C' and status_C in ' COMPLETE ':
