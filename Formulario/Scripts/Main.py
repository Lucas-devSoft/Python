...
while True:
    ...
    if option == 'A' and status_A in 'INCOMPLETE':
    ...
    elif option == 'B' and status_B in 'INCOMPLETE':
    ...
    elif option == 'C' and status_C in 'INCOMPLETE':
        ...
        if status_A == ' COMPLETE ' and status_B == ' COMPLETE ' and status_C == ' COMPLETE ':      
            ...
            if status_A in ' COMPLETE ' or status_B in ' COMPLETE ' or status_C in ' COMPLETE ':
