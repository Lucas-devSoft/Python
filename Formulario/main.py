        ...
        while True:
            ...
            if Tipo_de_conexion == "local":
                                ...
                                if retorno_nombre_bd == False:
                                    ...
                                    if Nombre_base_de_datos not in Conectado.list_database_names():
                                        ...
                                        Conectado.get_database(
                                            name=Nombre_base_de_datos).create_collection(
                                            name=Nombre_documentacion)
                                    ...
                                    for x in Conectado.get_database(Nombre_base_de_datos).list_collection_names():
                ...
                while True:
                    ...
                    Conectado_atlas = Conexión_Atlas(
                        Usuario, Password, Nombre_cluster, Identificador_cluster)
                            ...
                            if retorna_renombre == "si":
                                ...
                                while True:
                                    ...
                                    if retorno_nombre_bd == False:
                                        ...
                                        for x in Conectado_atlas.get_database(Nombre_base_de_datos).list_collection_names():
