...
{marco+fondo}█                                                                                      █{fin}""")
    opcion = input(
        f"{marco+fondo}█                      {texto}Escriba su respuesta aqui : {fin}              ").upper()
...
def Mensaje_error_borrado():

    print(f"""{marco+fondo}█                                                                                      █{fin}
{marco+fondo}█                        {texto_correcto}Los datos no pudieron ser borrados.                       {fin+marco}█{fin}
{marco+fondo}█                     {texto}Presione ENTER para continuar con el programa.                   {fin+marco}█{fin}  
{marco+fondo}█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█{fin}""")
    input()
