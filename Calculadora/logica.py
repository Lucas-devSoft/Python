...
def Banner(Estado: str, Nombre_servidor: str, Nombre_base_de_datos: str, Documentacion: str):
    ...
    print(f"""
{marco+fondo}█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█{fin}
{marco+fondo}█   {texto}      Estado: {Estado:^20}{fin+fondo}                                                 {fin+marco}█{fin}
{marco+fondo}█                                                                                      █{fin}
...
def opción_D():
    ...
    try:
        ...
        print(f"""{marco+fondo}█                                                                                      █{fin}
{marco+fondo}█          {texto}El resultado de la división es :                       {Resultado}                     {marco}█{fin}
{marco+fondo}█                                                                                      █{fin}""")
...
def opción_E():
    ...
    try:
        ...
        print(f"""{marco+fondo}█          {texto}El resultado de la potenciación es :                       {Resultado}                     {marco}█{fin}
{marco+fondo}█                                                                                      █{fin}""")
