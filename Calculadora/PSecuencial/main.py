                        ...
                        if Conexion_local:
                            ...
                            while True:
                                ...
                                if retorno_BD == "si":
                                    ...
                                    for x in Conexion_local.get_database(Nombre_de_base_de_datos).list_collection_names():
                                    ...
                                    Conexion_local.get_database(
                                        name=f"{Nombre_de_base_datos}").get_collection(name=f"{Documentacion}")
                            ...
                            if Conexion_atlas:
                                ...
                                while True:
                                    ...
                                    if retorno_BD == "si":
                                        ...
                                        for x in Conexion_atlas.get_database(Nombre_de_base_de_datos).list_collection_names():
                                        ...
                                        Conexion_atlas.get_database(
                                            name=f"{Nombre_de_base_de_datos}").get_collection(name=f"{Documentacion}")
                        ...
                        if retorno_respuesta == "si":
                            ...
                            if retorno_tipo_conexion == "local":
                                ...
                                if retorno_desplazamiento == "limpiar":
                                    ...
                                    # conexion.py
                                    retorno_limpiado = Limpiar_datos_local(
                                        retorno_BD, Conexion_local)
                                ...
                                if retorno_desplazamiento == "limpiar":
                                    ...
                                    # conexion.py
                                    retorno_limpiado = Limpiar_datos_atlas(
                                        retorno_BD, Conexion_atlas)
