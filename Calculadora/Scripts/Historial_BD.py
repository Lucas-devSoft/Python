    ...
    try:
        ...
        if conexion.is_connected():
            ...
            if numero2 == None:
                ...
                #sentencia = "Truncate historial" #Resetea el auntoincremento del ID, pero borra todos los datos de la tabla.
...
def error_guardado(guardar):
    ...
    while guardar != 'S' and guardar != 'N':
        ...
        input (' Sin embargo puede continuar sin guardar sus operaciones  ')
        break