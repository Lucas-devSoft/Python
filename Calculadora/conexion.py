...
def MongoDB_atlas():
    ...
    try:
        ...
        print(f"{marco+fondo}█                                                                                      █{fin}")
        print(f"{marco+fondo}█                    {texto}Aguarde verificando los datos de su servidor..                    {fin+marco}█{fin}")
...
def Mostrar_datos_local(creacion_db: str, Conexion_local: MongoClient):
    ...
    if creacion_db == "si":
        ...
        for i in documento.find():
            ...
            print(
                f"{marco+fondo}█       {texto}{resultado}         {marco+fondo}█{fin}")
...
def Limpiar_datos(creacion_db: str, Conexion_local: MongoClient):
    ...
    if creacion_db == "si":
        ...
        documento.delete_many({f"{Nombre_DC}": {"$exists": True}})
        ...
        documento.delete_many({"Historial": {"$exists": True}})
